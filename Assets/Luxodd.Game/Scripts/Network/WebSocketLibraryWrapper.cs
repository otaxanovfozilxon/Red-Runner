...
namespace Luxodd.Game.Scripts.Network
{
    ...
    public class WebSocketLibraryWrapper : MonoBehaviour
    {
        ...
        public static extern void Luxodd_ConnectWebSocket(string url);

        [DllImport("__Internal")]
        public static extern void Luxodd_SendWebSocketMessage(string message);

        [DllImport("__Internal")]
        public static extern void Luxodd_CloseWebSocket();

        [DllImport("__Internal")]
        public static extern void Luxodd_NavigateToHome();

        [DllImport("__Internal")]
        public static extern void Luxodd_SendSessionEndMessage();

        [DllImport("__Internal")]
        public static extern void Luxodd_SendSessionOptionsMessageWithAction(string action);
        
        [DllImport("__Internal")]
        private static extern void Luxodd_RegisterHostMessageListener(string goName);

        [DllImport("__Internal")]
        private static extern void Luxodd_SetExpectedHostOrigin(string origin);
        ...
        public void SendMessageToWebSocket(string message)
        {
            ...
            try
            {
                Luxodd_SendWebSocketMessage(message);
        ...
        private void PostSessionOptionCommand(SessionOptionAction sessionOptionAction)
        {
            ...
            Luxodd_SendSessionOptionsMessageWithAction(actionOption);
        }

        private void Awake()
        {
            Luxodd_RegisterHostMessageListener(gameObject.name);
        }
    }
}