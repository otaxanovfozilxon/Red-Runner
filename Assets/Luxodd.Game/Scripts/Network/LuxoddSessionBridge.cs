...
namespace Luxodd.Game.Scripts.Network
{
    ...
    private static extern void Luxodd_InitLuxoddSessionListener(string goName);

    [DllImport("__Internal")]
    private static extern string Luxodd_GetLuxoddSessionToken();

    [DllImport("__Internal")]
    private static extern string Luxodd_GetLuxoddSessionWsUrl();
        ...
        Luxodd_InitLuxoddSessionListener(gameObject.name);
        ...
        try
        {
            Token = Luxodd_GetLuxoddSessionToken();
            WebSocketUrl = Luxodd_GetLuxoddSessionWsUrl();
        ...
        WebSocketLibraryWrapper.Luxodd_ConnectWebSocket(WebSocketUrl);
#else
