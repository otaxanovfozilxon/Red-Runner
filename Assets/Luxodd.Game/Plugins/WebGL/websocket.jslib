mergeInto(LibraryManager.library, {
    Luxodd_ConnectWebSocket: function (urlPtr) {
    ...
    Luxodd_SendWebSocketMessage: function (messagePtr) {
    ...
    Luxodd_CloseWebSocket: function () {
        if (window.UnityWebSocket) {
    ...
    Luxodd_NavigateToHome: function () {
    ...
    Luxodd_SendSessionEndMessage: function () {
