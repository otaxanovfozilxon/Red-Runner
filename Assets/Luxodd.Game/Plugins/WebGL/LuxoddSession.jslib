mergeInto(LibraryManager.library, {
    Luxodd_InitLuxoddSessionListener: function (goNamePtr) {
        // Store state in window.__LuxoddSessionState
    ...
    Luxodd_GetLuxoddSessionToken: function () {
    ...
    Luxodd_GetLuxoddSessionWsUrl: function () {
        var S = window.__LuxoddSessionState || {};
        var wsUrl = S.wsUrl || "";
